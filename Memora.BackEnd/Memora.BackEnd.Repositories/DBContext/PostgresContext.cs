...
public partial class PostgresContext : DbContext
{
	...
	public virtual DbSet<ThemeItem> ThemeItems { get; set; }
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<ThemeItem>(entity =>
		{
			entity.HasKey(e => new { e.ThemeId, e.ItemId, e.DoorId }).HasName("theme_items_pkey");

			entity.ToTable("theme_items");

			entity.Property(e => e.ThemeId).HasColumnName("theme_id");
			entity.Property(e => e.ItemId).HasColumnName("item_id");
			entity.Property(e => e.DoorId).HasColumnName("door_id");

			entity.HasOne(d => d.Door).WithMany(p => p.ThemeItems)
				.HasForeignKey(d => d.DoorId)
				.HasConstraintName("theme_items_door_id_fkey");

			entity.HasOne(d => d.Item).WithMany(p => p.ThemeItems)
				.HasForeignKey(d => d.ItemId)
				.HasConstraintName("theme_items_item_id_fkey");

			entity.HasOne(d => d.Theme).WithMany(p => p.ThemeItems)
				.HasForeignKey(d => d.ThemeId)
				.HasConstraintName("theme_items_theme_id_fkey");
		});
